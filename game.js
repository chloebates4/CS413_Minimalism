...
var blanket = new PIXI.Sprite(PIXI.Texture.from("blanket_800_600.png"));
stage.addChild(blanket);

var ant = new PIXI.Sprite(PIXI.Texture.from("ant.png"));
ant.width = 50;
ant.height = 50;
ant.position.x = 750;
ant.position.y = 550;
...
var food = [
	...
	"watermelon.png", "watermelon.png", "watermelon.png"
];
var foodSprites = [];
